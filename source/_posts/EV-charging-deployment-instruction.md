---
uuid: 48948930-dc4a-11f0-a4c6-23e338cfa1bd
title: EV_charging_deployment_instruction
date: 2025-12-18 20:46:45
tags:
---
...
pythonCore/Central/EV_Central.py6001<localhost>:9092
...
pythonCharging_point/Registry/EV_Registry.py
...
pythonDriver/EV_Driver.py<localhost>:9092driver_1
...
pythonCharging_point/Engine/EV_CP_E.pylocalhost:9092--debug_port50032
...
pythonCharging_point/Monitor/EV_CP_M.pylocalhost:50032localhost:6001cp_001--locationMadrid
...
curlhttp://localhost:8000/ev/central/charging-points


# Verificar Registry

curl-khttps://localhost:7002/health


# Verificar base de datos

pythonscripts/test_db_connection.py
...
curlhttp://localhost:8000/ev/central/drivers


# Ver eventos de auditoría

curlhttp://localhost:8000/ev/central/audit-events
...
curlhttp://localhost:8000/ev/central/audit-events|python-mjson.tool
...
pythonscripts/tools/kafka_topic_reader.py
...
pythonscripts/decryMessageExample.py
